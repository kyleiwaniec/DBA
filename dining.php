<?php
$pagetitle = "Dining in Bordentown City";
require_once("header.php");
?>
<div class="wrapper">
    <div class="container">
        <div class="breadcrumb">
                                        <img src="images/hand.png" alt="pointer" /><a href="/"title="home">HOME</a><a href="members.php" title="Members">MEMBERS</a><span>DINING</span>
        ...
        <div id="centerCol">
            <div class="borderBox" style="border-top:10px solid #d3caba;">
              <span class="title">Downtown Bordentown</span><br/>
              <h2>DINING</h2>
              <div class="bodyCopy">
              <p>
                Whatever your taste in food, you are sure to find it in one of Bordentown's Fine Restaurants or Eateries.  Full course meals to quick lunches, snacks and treats, all are served up with small town charm and grace.  Italian, Latin, Cosmopolitan, South American, Old World, elegant and casual: its all here and most with either “Spirits Served or BYOB”. </p>
