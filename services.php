<?php
$pagetitle = "Services in Bordentown City";
require_once("header.php");
?>
<div class="wrapper">
    <div class="container">
        <div class="breadcrumb">
                                <img src="images/hand.png" alt="pointer" /><a href="/"title="home">HOME</a><a href="members.php" title="Members">MEMBERS</a><span>SERVICES</span>
        ...
        <div id="centerCol">
            <div class="borderBox" style="border-top:10px solid #2998ce;">
              <span class="title">Downtown Bordentown</span><br/>
              <h2>SERVICES</h2>
              <div class="bodyCopy">
              <p>
From Grooming to Wellness, to Finances and Law, Healing to Final Rest, Banking to Photography, Dentistry to Office Supplies, Martial Arts to Repair Services:  If you are in need of professional services, chances are, you can find what you need here in the “Little City With A Lot of Charm”.                 </p>
