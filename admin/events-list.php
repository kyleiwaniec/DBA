...
function renderEvents($event_type) {
    ...
    if ($rows > 0) {
        while ($data = mysql_fetch_assoc($events)) {
            ...
            echo "<div class='listitem {$isFeature} {$greyBg}'>
...
<!--            <img src="../images/cms-events-legend.png" alt="Legend"/><br/>-->
            ...
            <div id='events-tabs'>
                ...
                <div id="dba"><?php renderEvents('dba'); ?></div>
                <div id="member"><?php renderEvents('member'); ?></div>
                <div id="other"><?php renderEvents('other'); ?></div>
            </div><!-- #events-tabs -->
            <script>
