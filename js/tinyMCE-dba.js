...
tinyMCE.init({
	...
	plugins : "autolink,lists,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,advlist,images",
        ...
        // Theme options
        theme_advanced_buttons1 : "images,imgleft,|,bold,italic,underline,|,bullist,numlist,outdent,indent,|,undo,redo,|,link,unlink,|,fontsizeselect, styleselect,|,removeformat,|,code",
	...
	//media_external_list_url : "/admin/tinymce/examples/lists/media_list.js",
        ...
        style_formats : [
                ...
                {title : 'Left', selector : 'img', classes : 'lft inline-img'},
                {title : 'Right', selector : 'img', classes : 'rt inline-img'}
        ],
        ...
        formats : {
                ...
                imgleft : {selector : 'img', classes : 'lft inline-img'}, attributes : {title : 'Image Left'}}
        }
});
