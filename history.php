<?php
$pagetitle = "History of Bordentown City";
require_once("header.php");
?>
<div class="wrapper">
    <div class="container">
        <div class="breadcrumb">
                                        <img src="images/hand.png" alt="pointer" /><a href="/"title="home">HOME</a><span>HISTORY</span>
        ...
        <div id="centerCol">
            <div class="borderBox">
              ...
              <p><span class="dropcap">T</span>he area was settled in 1682 when Thomas Farnsworth, an English Quaker, moved up river from Burlington to make a new home for his family on a windswept bluff overlooking a broad bend in the Delaware River. Farnsworth Landing then became the center of trade for the region. Joseph Borden, for whom the town is named, arrived here in 1717. By May 1740 he had a line of stage coaches and boats traveling between New York and Philadelphia. With patriots Francis Hopkinson (a signer of the Declaration of Independence), Colonel Kirkbride, Colonel Hoagland, and Thomas Paine in residence, the area became a hotbed of revolutionary fervor. The town was occupied by the Hessians in 1776 and pillaged and burned by the British in May and June of 1778.
                ...
                <strong>We welcome your visit to charming Historic Bordentown City!</strong>
                </p><p>
                &raquo; <a href="guided-tour.php" title="Self Guided Tour">Take the Self-Guided Tour</a>
              </p>
              
              <p>&nbsp;</p>
              <h2>Thomas Paine</h2>
              <p><img src="images/TP-Portrait.jpg" alt="Portrait of Thomas Paine" class="fltlft inline-img lft" width="100"/>
              ...
              <p>&nbsp;</p>
              <h2>&ldquo;John Bull&rdquo;</h2>

              <p><img src="images/jb-2.jpg" alt="'The John Bull'" class="inline-img lft" width="150"/>
                ...
                <p>
                <img src="images/jb-1.jpg" alt="'The John Bull'" class="inline-img rt" width="200"/>
